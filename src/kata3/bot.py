...
def mayus(update, context):
    """Envia un mensaje a mayuscula cuando se emita el comando /mayus."""
    update.message.reply_text(context.args[0].upper())

def alreves(update, context):
    """Envia un mensaje al reves cuando no se emita un comando."""
    #
...
def main():
    ...
    updater = Updater("1155082026:AAHBYlC2LFfNP7s_iLIMj6014Qnz-T3K76M", use_context=True)
